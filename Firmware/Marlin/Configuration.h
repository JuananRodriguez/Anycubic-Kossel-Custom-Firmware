...
#define ANYCUBIC_PROBE_VERSION 2 //001 Elegir sensor de nivelado

// Heated Bed:
// 0 ... no heated bed
// 1 ... aluminium heated bed with "BuildTak-like" sticker
// 2 ... ultrabase heated bed
#define ANYCUBIC_KOSSEL_ENABLE_BED 1 //002 elegir tipo de cama
...
#define STRING_CONFIG_H_AUTHOR "4lexei.com 06/06/20" // Autor
...
#define CUSTOM_MACHINE_NAME "ANYCUBIC Kossel" //escribid lo que queráis entre las comillas
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Anycubic Kossel - run 'M106 S255' & 'M303 E0 C10 S200'
    ...
    #define DEFAULT_Kp_LIST {  19.00,  19.00 } //005 valores P I D del extrusor
    #define DEFAULT_Ki_LIST {   1.31,   1.31 }
    #define DEFAULT_Kd_LIST {  68.90,  68.90 }
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #if ANYCUBIC_KOSSEL_ENABLE_BED == 1 //006 si elegimos la cama caliente 1 usaremos estos valores:
    #define DEFAULT_bedKp 101.00
    #define DEFAULT_bedKi 06.97
    #define DEFAULT_bedKd 976.70
  #elif ANYCUBIC_KOSSEL_ENABLE_BED == 2 //007 si elegimos la cama caliente 2 (ultrabase) usaremos estos:
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_PRINTABLE_RADIUS 115.0  // Sobrepasar esa cifra no es seguro
  ...
  #define DELTA_HEIGHT 299.07             // (mm) Get this value from G33 auto calibrate //
 ...
 */
  ...
  #define NOZZLE_TO_PROBE_OFFSET { 0, 0, -13.0 } //003 si elegimos el sensor 2 usaremos este valor
#elif ANYCUBIC_PROBE_VERSION == 1
  #define NOZZLE_TO_PROBE_OFFSET { 0, 0, -13.0 } //004 si elegimos el sensor 1 usaremos este valor
#else
...
#define XY_PROBE_FEEDRATE (45*60)
